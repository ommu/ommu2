...
$this->registerJsFile('http://mozilla.github.io/pdf.js/build/pdf.js', ['position' => \app\components\View::POS_END]);
// $this->registerJsFile($pdfJsAsset->baseUrl . '/build/pdf.js', ['position' => \app\components\View::POS_END]);
...
JS;
$this->registerJs($jsFunction, \app\components\View::POS_END);
?>
